...
public class VHSController {
	...
	public ModelAndView rent(@PathVariable int id, Model model) {
	...
	public ModelAndView rent(@RequestParam int vhsid, @RequestParam String returnDate, Model model) {
		...
		rental.setDateUntil(Timestamp.valueOf(returnDate + " 12:00:00"));
		rental.setExpired(false);
		rentalService.addRental(rental);
		
		model.addAttribute("message", "Rent is completed. You have to return it before " + rental.getDateUntil());
